...
const Hero = () => {
  return (
    <section className="w-full bg-red-300 h-[100vh] overflow-hidden  xs:py-8 flex flex-col sm:py-2 md:flex-row justify-between md:gap-28 items-center py-14  hero">
      ...
      <div className="w-full md:w-[80%] flex flex-col  md:text-left md:items-start  md:h-[50%] md:justify-end  items-center justify-center text-center  gap-5 overflow-hidden">
        <div className="flex flex-col items-center md:items-start  justify-end gap-4 md:gap-0">
          <h3 className="uppercase text-2xl xs:text-3xl lg:text-5xl lg:leading-[50px] drop-shadow-lg text-white font-bold ">
        ...
        <p className="text-white md:hidden text-sm xs:text-base xs:w-[90%] md:w-[70%] md:text-lg">
